              ...
              <div>
                ...
                <div>
                  ...
                  {this.props.bookmarks.find(bk=>bk.show.name === this.props.data.name) ?
                    ...
                    :
                    <Button positive className="userButton" onClick={() => this.bookmarkButton(this.props.data)}> <Icon name="add"/>Add To Watch List</Button>
                  }
                  <Button color="blue" className="userButton" onClick={() => this.pageButton(this.props.data)}><Icon name="film"/>TV SHOW PAGE</Button>
